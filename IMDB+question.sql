...
--  columns with NULL values = country, worlwide_gross_income, languages, production_company
...
-- Action genre. Average Duration = 112.88
...
-- Top 5 actress: Taapsee Pannu, Kriti Sanon, Divya Dutta, Shraddha Kapoor, Kriti Kharbanda
...
movie_summary AS (
  SELECT 
    ...
    CAST(
      replace(
        replace(
          IFNULL(worlwide_gross_income, 0), 
          'INR', 
          ''
        ), 
        '$', 
